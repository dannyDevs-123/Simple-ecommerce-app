...
- The app is configured to serve static frontend files from the `frontend` folder.
- The backend runs on port `5000` by default.
- If you are using MongoDB Atlas, replace the connection string with your own database URI.
- Admin endpoints require an authenticated admin user.

## License

This project is intended for learning, demo, and development purposes.
